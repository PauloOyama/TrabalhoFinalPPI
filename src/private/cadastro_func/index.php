...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $expected_keys = ["nome", "email", "telefone", "cep", "logradouro",
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/private/cadastro_func/index.php" style="color:blue;">Funcionários</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown2">
                                <a class="dropdown-item "
                                    href="/private/listagem_de_dados/lista_todos_agend.php">Agendamentos -
                                Clientes</a>
                                <a class="dropdown-item " href="/private/listagem_de_dados/lista_agend_med.html">Agendamentos - Funcionário</a>
                                <a class="dropdown-item" href="/private/listagem_de_dados/lista_func.php">Funcionários</a>
                                <a class="dropdown-item "
                                    href="/private/listagem_de_dados/lista_pacientes.php">Pacientes</a>
                                <a class="dropdown-item "
                                    href="/private/listagem_de_dados/lista_enderecos.php">Endereços</a>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    httpReq.onreadystatechange = function() {
                        if (httpReq.readyState === XMLHttpRequest.DONE) {
                            if (httpReq.status === 200)
                                document.getElementById("modal-text").innerText = "Funcionário cadastrado com sucesso";
                            else if (httpReq.status === 409)
                                document.getElementById("modal-text").innerText = "Email já registrado";
                            else
                                document.getElementById("modal-text").innerText = "Erro inesperado";
