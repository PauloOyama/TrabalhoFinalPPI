                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown2">
                                <a class="dropdown-item "
                                    href="/private/listagem_de_dados/lista_enderecos.html">Endereços</a>
                                <a class="dropdown-item "
                                    href="/private/listagem_de_dados/lista_todos_agend.html">Agendamentos -
                                Clientes</a>
                                ...
                                <a class="dropdown-item "
                                    href="/private/listagem_de_dados/lista_pacientes.html">Pacientes</a>
                            </div>
                        </li>
                    </ul>
                </div>
