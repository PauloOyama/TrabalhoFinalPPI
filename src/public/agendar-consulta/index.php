...
<head>
    ...
    <link rel="stylesheet" href="/trabalhoFinal/public/css's/novo_endereco.css" />
...
<body>
    ...
    <script>
        ...
        function preencheEspecialidades() {
            ...
            httpReq.onreadystatechange = function() {
                if (httpReq.readyState === XMLHttpRequest.DONE) {
                    // Ações a serem feitas assim que a requição estiver completas
                    ...
                    opcaoNull.setAttribute("selected", "");
                    opcaoNull.setAttribute("disabled", "");
        ...
        function sendForm(event) {
            ...
            httpReq.onreadystatechange = function() {
                if (httpReq.readyState === XMLHttpRequest.DONE) {
                    if (httpReq.status === 200) document.getElementById("modal-text").innerText = "Consulta agendada com sucesso";
                    else document.getElementById("modal-text").innerText = "Ocorreu um erro inesperado";
