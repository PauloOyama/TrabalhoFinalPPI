                ...
                <form class="row gx-2 gy-4" action="./" method="POST" name="Cadastro">
                    <div class="col-md-4">
                        ...
                        <select name="especialidade" id="especialidade" class="form-select">
                            <option disabled selected>Carregando Opções...</option>
                        </select>
                    </div>
                    <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" class="form-control" id="data" name="data" disabled><span>Selecione o médico primeiro</span>
                    </div>
                    <div class="col-md-2">
                        <label for="horarioDisponivel" class="form-label">Horário para à consulta</label>
                        <select name="horarioDisponivel" id="horarioDisponivel" class="form-select" disabled>
                            <option disabled selected>--</option>
                        </select>
                    ...
                    <div class="col-md-6 ">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" autocomplete="off"><span></span>
                    </div>
                    <div class="col-md-6 ">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" class="form-control" id="email" placeholder="Ex: arel@vidal.com" name="email" autocomplete="off"><span></span>
                    </div>
                    <div class="col-md-4 ">
                        <label for="telefone" class="form-label">Telefone</label>
                        <input type="tel" class="form-control" id="telefone" name="telefone" placeholder="Ex: (xx) xxxxx-xxxx" pattern="([0-9]{2})[0-9]{5}-[0-9]{4}" autocomplete="off"><span></span>
                    </div>
                    <div class="col-md-12">
